<x-back-layout titel="Service Edit"  page="Delma" pagetitel="table">
    <div class="content">
                            ...
                            <div class="col-sm-12">
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" id="sid{{$value->id}}" class="odd">
                                            <td tabindex="0" class="sorting_1">{{$value->id}}</td>
                                            <td><a href="">{{$value->name_en}}</a></td>
                                            <td>{{$value->created_at}}</td>
                                            <td style="max-width:20px ;">
                                                <a class="modal-effect btn btn-sm btn-info" href="{{route('delma.edit', $value->id)}}" title="edit">
                                                    Edit
                                                </a>

                                                <a style="margin: auto;" class="modal-effect btn btn-sm btn-danger deleteProduct" data-token='{{ csrf_token() }}' data-id='{{$value->id}}' title="delete">
                                                    Delete
                                                </a>
